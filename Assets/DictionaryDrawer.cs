...
{
    private SerializebleDictionary<TK, TV> _dictionary;
    ...
    private void CheckInitialize(SerializedProperty property, GUIContent label)
    {
        if (_dictionary == null)
        {
            ...
            _dictionary = fieldInfo.GetValue(target) as SerializebleDictionary<TK, TV>;
            if (_dictionary == null)
            {
                _dictionary = new SerializebleDictionary<TK, TV>();
...
[CustomPropertyDrawer(typeof(TestDictionary1))]
public class MyDictionaryDrawer1 : DictionaryDrawer<string, int> { }

[CustomPropertyDrawer(typeof(TestDictionary2))]
public class MyDictionaryDrawer2 : DictionaryDrawer<Vector2, GameObject> { }